...
if __name__ == "__main__":
    ...
    python_file = "/home/alex.piet/codebase/GLM/visual_behavior_glm_strategy/scripts/response_dataframes.py"
    stdout_basedir = "/allen/programs/braintv/workgroups/nc-ophys/visual_behavior/ophys_glm"
    stdout_location = os.path.join(stdout_basedir, 'job_records_response_dataframes_events_updates_v8')
